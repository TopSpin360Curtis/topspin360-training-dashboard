...
import { getLoginPathForRoute } from "@/lib/auth";
import type {
  BenchmarkConfig,
  CoachNote,
  DataSourceMeta,
...
type CohortKey =
  ...
  | "high-frequency"
  | "low-frequency";
type DatePreset = "last7" | "last30" | "season" | "season2024" | "season2023" | "allTime";
  ...
  return (
    <div className="min-h-screen pb-10">
      <Navbar
        ...
        tenantLoginPath={
          authenticatedTenant
            ? getLoginPathForRoute(authenticatedTenant.loginRoute)
            : undefined
        }
